...
export function montarSystemPrompt(
  ...
  const partes = [
    ...
    [
      ...
      "  encontrar a reserva, confira se o cliente_nome devolvido bate com o que a pessoa te disse. So depois",
      "  disso, e ANTES de efetivamente chamar modify_my_reservation ou cancel_my_reservation, peca uma",
      "  confirmacao explicita da propria alteracao/cancelamento (ex: \"posso confirmar o cancelamento da",
      "  reserva de Joao as 20h?\") e so chame a tool depois que a pessoa confirmar. Nunca altere ou cancele",
      "  so por suspeita ou sem essa confirmacao.",
