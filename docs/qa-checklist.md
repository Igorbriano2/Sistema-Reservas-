...
| 11 | Loading, vazio, erro e sucesso tratados | ✅ | `Skeleton`/`EmptyState` aplicados em Dashboard, Reservas e agora também `TablesPage` (era o único `<p>Carregando...</p>` solto que sobrava, corrigido no fechamento das pendências) |
